...
export default function MyRequisitionsPage() {
    ...
    return (
        <div className="container mx-auto p-8 bg-gray-100 min-h-screen text-black">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-gray-800">My Requisitions</h1>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 text-black">
                            {myRequisitions.map((req) => (
                                <tr key={req.id}>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">{req.itemName}</td>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm">{new Date(req.created).toLocaleDateString()}</td>
